...
tf.app.flags.DEFINE_string('log_root', log_path, 'Root directory for all logging.')
...
tf.app.flags.DEFINE_integer('max_dec_steps', 130, 'max timesteps of decoder (max summary tokens)')
tf.app.flags.DEFINE_integer('beam_size', 4, 'beam size for beam search decoding.')
tf.app.flags.DEFINE_integer('min_dec_steps', 60, 'Minimum sequence length of generated summary. Applies only for beam search decoding mode')
